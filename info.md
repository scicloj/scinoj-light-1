...
#### Analyzing Nairobi Bus Routes with Graph Algorithms and Agent-based Simulation
Speaker: Julius
...
#### FlowStorm: understanding code by visualizations of execution recordings
Speaker: Alejandro
Joins the Q&A: Juan
...
See the schedule drafts in separate files.
